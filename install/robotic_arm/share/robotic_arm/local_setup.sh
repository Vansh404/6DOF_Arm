...
: ${AMENT_CURRENT_PREFIX:="/home/vansh/ros2_ws/install/robotic_arm"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robotic_arm/environment/pythonpath.sh"
